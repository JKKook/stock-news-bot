...
국내·해외 주식 관련 이슈를 **12시간마다 자동으로 모아 디스코드로 보내주는** 봇입니다.
구글 뉴스(무료, API 키 불필요)에서 뉴스를 수집합니다.

- 시장 전체: 코스피 / 코스닥 / 나스닥 / S&P·다우 / 환율·금리
- 관심 종목: 삼성전자, SK하이닉스, 애플, 엔비디아, 테슬라 (자유롭게 변경 가능)
- 실행: GitHub Actions가 **한국시간 오전 9시 · 오후 9시** 자동 실행
...
3. 디스코드 채널에 브리핑이 도착하면 성공! 이후엔 12시간마다 자동으로 옵니다.
